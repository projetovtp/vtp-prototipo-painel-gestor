...
const GestorFinanceiroPage = () => {
  ...
  const refModalDetalhes = useFocusTrap(modalDetalhesAberto, () => setModalDetalhesAberto(false));
  const refModalVendas = useFocusTrap(modalDetalhesVendasAberto, () => setModalDetalhesVendasAberto(false));
  const refModalTotal = useFocusTrap(modalDetalhesTotalAberto, () => setModalDetalhesTotalAberto(false));
  const refModalRepasse = useFocusTrap(modalSolicitarRepasseAberto, () => !solicitandoRepasse && setModalSolicitarRepasseAberto(false));
  const refModalSucesso = useFocusTrap(modalSucessoRepasseAberto, () => setModalSucessoRepasseAberto(false));
  ...
  async function carregarDados() {
    ...
    try {
      ...
      if (repassesData.status === "fulfilled") setRepasses(Array.isArray(repassesData.value) ? repassesData.value : []);
      if (reservasDia.status === "fulfilled") setReservasPorDia(Array.isArray(reservasDia.value) ? reservasDia.value : []);
      if (transacoesData.status === "fulfilled") setTransacoesConcluidas(Array.isArray(transacoesData.value) ? transacoesData.value : []);
          ...
          <div className="dash-modal-overlay" onClick={() => setModalDetalhesAberto(false)}>
            ...
            >
              <div className="dash-modal-header">
                ...
                <button type="button" className="dash-modal-close" aria-label="Fechar modal" onClick={() => setModalDetalhesAberto(false)}>×</button>
              </div>
          ...
          <div className="dash-modal-overlay" onClick={() => setModalDetalhesVendasAberto(false)}>
            ...
            >
              <div className="dash-modal-header">
                ...
                <button type="button" className="dash-modal-close" aria-label="Fechar modal" onClick={() => setModalDetalhesVendasAberto(false)}>×</button>
              </div>
          ...
          <div className="dash-modal-overlay" onClick={() => !solicitandoRepasse && setModalSolicitarRepasseAberto(false)}>
            ...
            >
              <div className="dash-modal-header">
                ...
                <button type="button" className="dash-modal-close" aria-label="Fechar modal" onClick={() => !solicitandoRepasse && setModalSolicitarRepasseAberto(false)} disabled={solicitandoRepasse}>×</button>
              </div>
          ...
          <div className="dash-modal-overlay dash-modal-overlay--top" onClick={() => setModalSucessoRepasseAberto(false)}>
            ...
            >
              <div className="gf-success-modal">
                ...
                <button type="button" className="gf-success-btn" onClick={() => setModalSucessoRepasseAberto(false)}>Entendi</button>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="dash-modal-overlay" onClick={() => setModalDetalhesTotalAberto(false)}>
            ...
            >
              <div className="dash-modal-header">
                ...
                <button type="button" className="dash-modal-close" aria-label="Fechar modal" onClick={() => setModalDetalhesTotalAberto(false)}>×</button>
              </div>
                      ...
                      <div className="gf-detail-list">
                        {reservasPorDia.map((reserva, index) => (
                          <div key={index} className="gf-detail-list-item">
                            <div>
                              <div className="gf-detail-list-date">{formatDateBR(reserva.data instanceof Date ? reserva.data.toISOString() : reserva.data)}</div>
                      ...
                      <div className="gf-detail-list">
                        {transacoesConcluidas.map((transacao) => (
                          <div key={transacao.id} className="gf-detail-list-item">
                            <div style={{ flex: 1 }}>
                              <div className="gf-detail-list-date">{formatDateBR(transacao.data instanceof Date ? transacao.data.toISOString() : transacao.data)}</div>
